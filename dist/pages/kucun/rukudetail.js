...
var RuKuDetailPage = (function (_super) {
    __extends(RuKuDetailPage, _super);
    function RuKuDetailPage() {
    ...
    RuKuDetailPage.prototype.InitData = function (options) {
    ...
    RuKuDetailPage.prototype.scrolltolower = function () { };
    RuKuDetailPage.prototype.MoreHandler = function () {
        this._SetData({ IsShowMore: true });
    };
    RuKuDetailPage.prototype.CanlerHandler = function () {
        this._SetData({ IsShowMore: false });
    };
    RuKuDetailPage.prototype.SelectDateHandler = function (e) {
    ...
    RuKuDetailPage.prototype.CanlerRuKuHandler = function () {
        var _this = this;
        wx.showModal({
            title: "提示信息",
            content: "确定取消入库么？",
