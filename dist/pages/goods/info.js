...
var infoPage = (function (_super) {
    ...
    infoPage.prototype.InitData = function (options) {
    ...
    infoPage.prototype.more = function () {
        this._SetData({ IsModel: true });
    };
    infoPage.prototype.delete = function () {
        wx.showModal({
            title: '提示',
            content: '是否删除该商品？',
    ...
    infoPage.prototype.updateStatus = function () {
        wx.showModal({
            title: '提示',
            content: '是否下架该商品？',
            success: function (res) {
