...
var IndexPage = (function (_super) {
    ...
    IndexPage.prototype.InitDay = function () {
    ...
    IndexPage.prototype.InitDate = function () {
        ...
        this._SetData({
            dayArr: arr,
            day: this.p_date,
            fullData: Utils_1.formartDate(this.p_year, this.p_month + 1, this.p_day, "-")
        });
    };
    IndexPage.prototype.selectday = function (e) {
    ...
    IndexPage.prototype.nextMonth = function () {
    ...
    IndexPage.prototype.prevMonth = function () {
        if (this.p_month - 1 < 0) {
            this.p_year -= 1;
            this.p_month = 11;
        }
